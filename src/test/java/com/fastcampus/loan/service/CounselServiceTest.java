...
public class CounselServiceTest {
    ...
    void Should_ReturnResponseOfNewCounselEntity_When_RequestCounsel(){
        ...
        // mocking처리에 counselRepository.save를 호출할 경우 들어온 인자값이 Counsel 클래스라면 entity를 리턴하라는 내용
    ...
    @Test
    void Should_ReturnResponseOfExistCounselEntity_When__RequestExistCounselId(){
        Long findId = 1L;
